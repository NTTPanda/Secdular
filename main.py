...
#             elif pass_start > now:
#                 upcoming_passes.append((formatted_date, sd, code, start_time, end_time))  # Upcoming

#         # Sort by time and return
#         upcoming_passes = sorted(upcoming_passes, key=lambda x: (x[0], x[3]))[:6]
...
#     # Insert into tables
#     for item in ongoing:
#         ongoing_tree.insert("", "end", values=item)
#     for item in upcoming:
#         upcoming_tree.insert("", "end", values=item)
...
#     img = img.resize((120, 80))  # Resize for display
